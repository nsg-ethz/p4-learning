...
sudo ip netns exec h1 ifconfig h1-eth0 hw ether 00:00:0a:00:01:01 10.0.1.1/24 up
sudo ip netns exec h2 ifconfig h2-eth0 hw ether 00:00:0a:00:02:02 10.0.2.2/24 up
