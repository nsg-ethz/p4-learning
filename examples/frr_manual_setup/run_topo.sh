...
# Run FRRouters
sudo ip netns exec r1 zebra -d -u root -g root -N r1 -M fpm -i /tmp/r1-zebra.pid --log file:/tmp/r1-zebra.log --log-level debugging > /tmp/r1-zebra.out 2>&1
...
sudo ip netns exec r2 zebra -d -u root -g root -N r2 -M fpm -i /tmp/r2-zebra.pid --log file:/tmp/r2-zebra.log --log-level debugging > /tmp/r2-zebra.out 2>&1
...
sudo ip netns exec r3 zebra -d -u root -g root -N r3 -M fpm -i /tmp/r3-zebra.pid --log file:/tmp/r3-zebra.log --log-level debugging > /tmp/r3-zebra.out 2>&1
