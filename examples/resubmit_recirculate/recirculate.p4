...
control MyEgress(inout headers hdr,
                 inout metadata meta,
                 inout standard_metadata_t standard_metadata) {
   register<bit<16>>(256) recirculate_register;
   apply {
        if (hdr.ipv4.isValid()){
            recirculate_register.write((bit<32>)meta.recirculate_meta.i, hdr.ipv4.identification);
            if (meta.recirculate_meta.i < hdr.ipv4.tos){
