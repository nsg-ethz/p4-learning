...
class RoutingController(object):
    ...
    def initialize_tables(self):
        ...
        #set static rules
        self.controllers["s1"].table_add("ipv4_lpm", "ipv4_forward", ["10.0.1.2/32"], ["00:00:0a:00:01:02", "1"])
        ...
        self.controllers["s4"].table_add("ipv4_lpm", "ipv4_forward", ["10.0.2.2/32"], ["00:00:0a:00:02:02", "3"])
        self.controllers["s4"].table_add("ipv4_lpm", "ipv4_forward", ["10.250.250.2/32"], ["00:00:0a:fa:fa:02", "4"])
