...
# Network definition
net.addP4Switch('s1', conf_path='sx-commands/s1-commands.txt')
net.addP4Switch('s2', conf_path='sx-commands/s2-commands.txt')
net.addP4Switch('s3', conf_path='sx-commands/s3-commands.txt')
net.addP4Switch('s4', conf_path='sx-commands/s4-commands.txt')
net.addP4Switch('s5', conf_path='sx-commands/s5-commands.txt')
net.addP4Switch('s6', conf_path='sx-commands/s6-commands.txt')
net.addP4Switch('s7', conf_path='sx-commands/s7-commands.txt')
